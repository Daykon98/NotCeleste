...
public class RippleEffect : MonoBehaviour
{
    ...
    class Droplet
    {
        ...
        public void ResetWithPosition(Vector2 newPosition)
        {
    ...
    public void EmitWithPosition(Vector2 position)
    {
        droplets[dropCount++ % droplets.Length].ResetWithPosition(position);
    }
}
